...
public class StudySqlProvider {
	...
	public String insertSelective(Study record) {
		BEGIN();
		INSERT_INTO("study");
		if (record.getStudyname() != null) {
			VALUES("studyname", "#{studyname,jdbcType=VARCHAR}");
		}
		return SQL();
	}
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		...
		if (record.getStudyname() != null) {
			SET("studyname = #{record.studyname,jdbcType=VARCHAR}");
		}
	...
	public String updateByPrimaryKeySelective(Study record) {
		...
		UPDATE("study");
		if (record.getStudyname() != null) {
			SET("studyname = #{studyname,jdbcType=VARCHAR}");
		}
