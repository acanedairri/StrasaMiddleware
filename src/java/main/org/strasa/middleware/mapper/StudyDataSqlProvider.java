...
import org.strasa.middleware.model.StudyDataExample.Criteria;
import org.strasa.middleware.model.StudyDataExample.Criterion;
import org.strasa.middleware.model.StudyDataExample;

public class StudyDataSqlProvider {
	 ...
	 */
	public String countByExample(StudyDataExample example) {
		BEGIN();
		SELECT("count(*)");
		FROM("studydata");
	 ...
	 * @mbggenerated  Wed Sep 11 13:30:06 SGT 2013
	 */
	public String deleteByExample(StudyDataExample example) {
		BEGIN();
		DELETE_FROM("studydata");
		applyWhere(example, false);
		return SQL();
	}
	 ...
	 * @mbggenerated  Wed Sep 11 13:30:06 SGT 2013
	 */
	public String insertSelective(StudyData record) {
		BEGIN();
		INSERT_INTO("studydata");
	 ...
	 * @mbggenerated  Wed Sep 11 13:30:06 SGT 2013
	 */
	public String selectByExample(StudyDataExample example) {
		BEGIN();
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		StudyData record = (StudyData) parameter.get("record");
		StudyDataExample example = (StudyDataExample) parameter.get("example");
		BEGIN();
		UPDATE("studydata");
		if (record.getId() != null) {
	 ...
	 * @mbggenerated  Wed Sep 11 13:30:06 SGT 2013
	 */
	public String updateByPrimaryKeySelective(StudyData record) {
		BEGIN();
		UPDATE("studydata");
		if (record.getStudyid() != null) {
	 ...
	 * @mbggenerated  Wed Sep 11 13:30:06 SGT 2013
	 */
	protected void applyWhere(StudyDataExample example,
